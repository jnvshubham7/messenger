...
err_media_devices_are_null = Вероятно, конфигурация Вашего браузера не позволяет получить медиа устройства. Подкорректируйте настройки и убедитесь в доступности медиа устройств.
err_message_cannot_be_deleted = Сообщение уже не может быть удалено.
...
err_wrong_replying_item_count = Некорректное количество ответов
...
label_add_email_confirmation_sent = Одноразовый код был отправлен на ваш адрес электронной почты. Если вы не получили письма, проверьте введенные данные или папку со спамом.
label_add_email_confirmation_sent_again = Одноразовый код был повторно отправлен на ваш адрес электронной почты. Если вы не получили письма, проверьте введенные данные или папку со спамом.
label_add_email_confirmation_sent_to = Одноразовый код был отправлен на {$email}. Если вы не получили письма, проверьте введенные данные или папку со спамом.
...
label_one_time_code_hint = Введите код
label_online = онлайн
...
label_voice_processing = Обработка звука
...
label_your_direct_link = Прямая ссылка на Ваш чат
